...
<head>
    ...
    <title>@yield('title', 'Rently') — Properties to Rent</title>
...
<body class="bg-gray-50 text-gray-900 antialiased">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <a href="/" class="text-xl font-bold text-indigo-600">Rently</a>
    ...
    <footer class="bg-white border-t mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex justify-between items-center text-sm text-gray-500">
            <span>&copy; {{ date('Y') }} Rently. All rights reserved.</span>
